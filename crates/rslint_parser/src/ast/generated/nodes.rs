...
impl TsTemplate {
	pub fn elements(&self) -> AstNodeList<TsTemplateElement> {
...
impl TsTypeArgs {
	...
	pub fn args(&self) -> AstNodeList<TsType> {
		support::list(&self.syntax)
	}
...
impl TsTypeParams {
	...
	pub fn params(&self) -> AstNodeList<TsTypeParam> {
		support::list(&self.syntax)
	}
	pub fn r_angle_token(&self) -> Option<SyntaxToken> {
		support::token(&self.syntax, T ! [>])
...
impl TsModuleBlock {
	...
	pub fn items(&self) -> AstNodeList<ModuleItem> {
		support::list(&self.syntax)
	}
	pub fn r_curly_token(&self) -> Option<SyntaxToken> {
		support::token(&self.syntax, T!['}'])
...
impl TsIndexSignature {
	pub fn decorators(&self) -> AstNodeList<TsDecorator> {
		support::list(&self.syntax)
	}
	pub fn readonly_token(&self) -> Option<SyntaxToken> {
		support::token(&self.syntax, T![readonly])
...
impl TsInterfaceDecl {
	...
	pub fn extends(&self) -> AstNodeList<TsExprWithTypeArgs> {
		support::list(&self.syntax)
	}
	pub fn l_curly_token(&self) -> Option<SyntaxToken> {
		support::token(&self.syntax, T!['{'])
...
impl Script {
	...
	pub fn items(&self) -> AstNodeList<Stmt> {
		support::list(&self.syntax)
	}
}
#[doc = ""]
...
impl NamedImports {
	...
	pub fn specifiers(&self) -> AstNodeList<Specifier> {
		support::list(&self.syntax)
	}
	pub fn r_curly_token(&self) -> Option<SyntaxToken> {
		support::token(&self.syntax, T!['}'])
...
impl BlockStmt {
	...
	pub fn stmts(&self) -> AstNodeList<Stmt> {
		support::list(&self.syntax)
	}
	pub fn r_curly_token(&self) -> Option<SyntaxToken> {
		support::token(&self.syntax, T!['}'])
...
impl VarDecl {
	...
	pub fn declared(&self) -> AstNodeList<Declarator> {
		support::list(&self.syntax)
	}
	pub fn semicolon_token(&self) -> Option<SyntaxToken> {
		support::token(&self.syntax, T ! [;])
...
impl ContinueStmt {
	...
	pub fn ident(&self) -> Option<NameRef> {
		support::child(&self.syntax)
	}
	pub fn semicolon_token(&self) -> Option<SyntaxToken> {
		support::token(&self.syntax, T ! [;])
...
impl SwitchStmt {
	...
	pub fn cases(&self) -> AstNodeList<SwitchCase> {
		support::list(&self.syntax)
	}
	pub fn r_curly_token(&self) -> Option<SyntaxToken> {
		support::token(&self.syntax, T!['}'])
...
impl CaseClause {
	...
	pub fn cons(&self) -> AstNodeList<Stmt> {
		support::list(&self.syntax)
	}
}
#[doc = ""]
...
impl ParameterList {
	...
	pub fn parameters(&self) -> AstNodeList<Pattern> {
		support::list(&self.syntax)
	}
	pub fn r_paren_token(&self) -> Option<SyntaxToken> {
		support::token(&self.syntax, T![')'])
...
impl ArrayExpr {
	...
	pub fn elements(&self) -> AstNodeList<ExprOrSpread> {
		support::list(&self.syntax)
	}
	pub fn r_brack_token(&self) -> Option<SyntaxToken> {
		support::token(&self.syntax, T![']'])
...
impl ObjectExpr {
	...
	pub fn props(&self) -> AstNodeList<ObjectProp> {
		support::list(&self.syntax)
	}
	pub fn r_curly_token(&self) -> Option<SyntaxToken> {
		support::token(&self.syntax, T!['}'])
...
impl ArgList {
	...
	pub fn args(&self) -> AstNodeList<Expr> {
		support::list(&self.syntax)
	}
	pub fn r_paren_token(&self) -> Option<SyntaxToken> {
		support::token(&self.syntax, T![')'])
...
impl SequenceExpr {
	pub fn exprs(&self) -> AstNodeList<Expr> {
		support::list(&self.syntax)
	}
}
#[doc = ""]
...
impl Template {
	...
	pub fn elements(&self) -> AstNodeList<TemplateElement> {
		support::list(&self.syntax)
	}
}
#[doc = ""]
...
impl ClassDecl {
	...
	pub fn implements(&self) -> AstNodeList<TsExprWithTypeArgs> {
		support::list(&self.syntax)
	}
...
impl ClassBody {
	...
	pub fn elements(&self) -> AstNodeList<ClassElement> {
		support::list(&self.syntax)
	}
	pub fn r_curly_token(&self) -> Option<SyntaxToken> {
		support::token(&self.syntax, T!['}'])
